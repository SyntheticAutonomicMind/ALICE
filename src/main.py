...
def check_nsfw_content(text: str) -> bool:
    ...
    """
    # Common NSFW keywords (case-insensitive)
    nsfw_keywords = [
        "nude", "naked", "nsfw", "porn", "erotic", "xxx",
        "sex", "sexual", "explicit", "adult only",
        "topless", "bottomless", "lingerie", "underwear",
        "hentai", "lewd", "aroused", "seductive",
        "provocative", "suggestive", "sultry"
    ]
    ...
    for keyword in nsfw_keywords:
        if keyword in text_lower:
            logger.warning("NSFW content blocked: keyword '%s' detected in prompt", keyword)
            return True
